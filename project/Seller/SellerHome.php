  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <?php $selQry = "select * from tbl_seller where seller_id='" . $selid . "'";
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="MyProduct.php">Manage Products</a></li>
              </ul>
            </div>
          </li>
      ...
      <div class="main-panel">
        <div class="scroll-container">
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin">
                <div class="row">
                  ...
                  $selQry = "select * from tbl_seller where seller_id='" . $selid . "'";
            ...
            <div class="row">
              ...
              $selqry = "SELECT COUNT(*) as count FROM tbl_order o inner join tbl_cart c on o.order_id=c.order_id inner join tbl_product p on c.product_id=p.product_id where cart_status in(1,2,3,4) and seller_id=" . $selid . " and order_date=curdate()";
              ...
              <div class="col-md-6 grid-margin transparent">
                <div class="row">
                  ...
                  $seltot = "SELECT IFNULL(sum(cart_quantity), 0) as count FROM tbl_order o inner join tbl_cart c on o.order_id=c.order_id inner join tbl_product p on c.product_id=p.product_id where cart_status in (1,3,4) and seller_id=" . $selid . "";
                  ...
                  <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-dark-blue" style="background-color:#2C6899">
                      <div class="card-body">
                        <p class="mb-4">Total number of products ordered </p>
                        <p class="fs-30 mb-2">
                          <?php echo $ordertot ?>
                        </p>
                      </div>
                ...
                $sellsel = "SELECT COUNT(*) as count FROM tbl_follow where seller_id=" . $selid . "";
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                    <div class="card card-light-blue" style="background-color:#E5D1B9">
                      <div class="card-body">
                        <p class="mb-4">Number of followers</p>
                        <p class="fs-30 mb-2">
                          <?php echo $totsell ?>
                        </p>
                  ...
                  $selcus = "SELECT COUNT(*) as count FROM tbl_product where seller_id=" . $selid . "";
                  ...
                  <div class="col-md-6 stretch-card transparent">
                    <div class="card card-light-danger" style="background-color:#B3D0DB">
                      <div class="card-body">
                        <p class="mb-4">Number of products sold </p>
                        <p class="fs-30 mb-2">
                          <?php echo $totcus ?>
                        </p>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 grid-margin stretch-card" style="margin-top:-60px;">
                <div class="card">
                  <div class="card-body">
                    <div style="text-align:right;">
                      <a style="text-align:right;text-decoration:none;" href="SalesByProdPie.php">view more</a>
                    </div>
                    <h4 class="card-title">Sales Per Product -Pie Chart</h4><br><br>
        ...
        $xValues = [];
        $yValues = [];
        $sel = "select * from tbl_product where Seller_id=" . $selid . "";
        $row = $conn->query($sel);
        while ($data = $row->fetch_assoc()) {
          $xValues[] = $data["prod_name"];
          $sel1 = "select IFNULL(sum(cart_quantity), 0) as id from tbl_cart c inner join tbl_product p on c.product_id=p.product_id where ( cart_status in (1,3,4) and p.product_id = '" . $data["product_id"] . "')";
          $row1 = $conn->query($sel1);
          while ($data1 = $row1->fetch_assoc()) {
            $yValues[] = $data1["id"];
          }
