	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 p-b-50" style="max-width:600px;">
				...
				<div><span style="color:#ddd;">The Objective of Artisanal is to support small handicraft business and
						make a website that is fully dedicated to handmade products which attracts customer who like or
						prefer unique handmade
						products over machine made mass produced products. Artisanal sells a wide range of handmade
						products like paintings, bags, wallets, hats, key chains, cups, home decors etc.
						And simple cloths like scarves, mufflers, sweaters, Beanies etc. Artisanal wants to give an
				...
				<form>
					<div class="wrap-input1 w-full p-b-4">
						<a class="input1 bg-none plh1 stext-107 cl7" target="_blank"
							href="https://www.linkedin.com/in/sinju-mathews-1042a7292"><i class="zmdi zmdi-linkedin"
								style="font-size:23px;color:#fff;"></i> <span
	...
	<div class="container">
		<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
			<button class="how-pos3 hov3 trans-04 js-hide-modal1">
				<img src="../Assets/Template/Main/images/icons/icon-close.png" alt="CLOSE">
			</button>
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="../Assets/Template/Main/images/product-detail-01.jpg"
											alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="../Assets/Template/Main/images/product-detail-01.jpg">
								...
								<div class="item-slick3" data-thumb="images/product-detail-02.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="../Assets/Template/Main/images/product-detail-02.jpg"
											alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="../Assets/Template/Main/images/product-detail-02.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								...
								<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="../Assets/Template/Main/images/product-detail-03.jpg"
											alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="../Assets/Template/Main/images/product-detail-03.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
