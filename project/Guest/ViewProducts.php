                    ...
                    success: function (data) {
                        ...
                        if (data.review_data.length > 0) {
                            ...
                            for (var count = 0; count < data.review_data.length; count++) {
                                ...
                                html += '<div class="col-sm-1" style="max-width: 6.7%;"><div class="rounded-circle bg-info text-white pt-2 pb-2"><h3 class="text-center">' + data.review_data[count].user_name.charAt(0) + '</h3></div></div>';
